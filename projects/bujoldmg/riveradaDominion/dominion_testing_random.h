#ifndef DOMINION_TESTING_RANDOM_H
#define DOMINION_TESTING_RANDOM_H
...
#define TEST_PLAYED					" %s -- playedCards content incorrect\n"
#define TEST_HAND					" %s -- hand contents incorrect\n"
#define TEST_DISCARD				" %s -- discard pile contents incorrect\n"
#define TEST_DECK					" %s -- deck contents incorrect\n"
#define TEST_SUPPLY					" %s -- supply piles content incorrect\n"
...
#define TEST_HAND_PLAYER			" %s -- player %d hand contents incorrect\n"
#define TEST_DISCARD_PLAYER			" %s -- player %d discard pile contents incorrect\n"
#define TEST_DECK_PLAYER			" %s -- player %d deck contents incorrect\n"
#define TEST_ALLCARDS_PLAYER		" %s -- player %d hand + discard + deck combined content incorrect\n"
